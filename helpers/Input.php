...
class Input {
	...
	public function postFloat($key){
		return filter_var(filter_input(INPUT_POST, $key, FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION), FILTER_VALIDATE_FLOAT);
	}

	public function getFloat($key){
		return filter_var(filter_input(INPUT_GET, $key, FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION), FILTER_VALIDATE_FLOAT);
	}
	...
	public function postRaw($key){
		return filter_input(INPUT_POST, $key, FILTER_UNSAFE_RAW);
	}

	public function getRaw($key){
		return filter_input(INPUT_GET, $key, FILTER_UNSAFE_RAW);
	}
